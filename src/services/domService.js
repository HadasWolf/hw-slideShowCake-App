...
export const CAKES_PAGE = document.getElementById("cakes-page");
export const SWEETS_PAGE = document.getElementById("sweets-page");
export const SIGNUP_PAGE = document.getElementById("signup-page");
export const LOGIN_PAGE = document.getElementById("login-page");
export const EROR404_PAGE = document.getElementById("error-404-page");
...
export const CAKES_PAGE_LINK = document.getElementById("cakes-page-link");
export const SWEETS_PAGE_LINK = document.getElementById("sweets-page-link");
...
export const EROR404_PAGE_LINK = document.getElementById("error-404-page-link");
//*******links******* */
